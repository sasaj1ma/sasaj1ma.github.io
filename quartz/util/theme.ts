...
const DEFAULT_SANS_SERIF = `'Gen Interface JP', Helvetica, Arial, 'Yu Gothic Medium', YuGothic, 'Yu Gothic', 'Hiragino Sans', 'Hiragino Kaku Gothic ProN', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'`
